        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('get-slider-form')}}">New Slider</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('view-all-sliders')}}">All Sliders</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
